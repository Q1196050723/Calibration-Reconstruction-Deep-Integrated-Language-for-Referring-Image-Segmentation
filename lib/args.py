...
def get_parser():
    ...
    parser.add_argument('--bert_tokenizer', default='/mnt/data/ycyan/LAVT/bert', help='BERT tokenizer')
    parser.add_argument('--ck_bert', default='/mnt/data/ycyan/LAVT/bert', help='pre-trained BERT weights')
    ...
    parser.add_argument('--hidden_size', default=2048, type=int, help='hidden_size in decoder')
    parser.add_argument('--num_layers', default=2, type=int, help='num_layers in decoder')
    parser.add_argument('--refer_data_root', default='./refer/data/', help='REFER dataset root directory')
    parser.add_argument('--resume', default='/mnt/data/ycyan/LAVT/checkpoints/model_best_gref_umd_ICMR.pth', help='resume from checkpoint')
    ...
    parser.add_argument('--query_number', default=16, type=int, help='query_number')
    return parser
